...
# io$samples_indir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/rna/raw/allele_unspecific"
# io$outfile <- "/hps/nobackup/stegle/users/ricard/NMT-seq/rna/parsed/allele_unspecific/raw_counts.txt"

io$anno_infile <- "/Users/ricard/data/ensembl/mouse/v87/GTF/mRNA/Mus_musculus.GRCm38.87.gtf"
# io$samples_indir <- "/Users/ricard/data/NMT-seq/rna/raw/allele_unspecific"
# io$outfile <- "/Users/ricard/data/NMT-seq/rna/parsed/allele_unspecific/raw_counts.txt"
io$samples_indir <- "/Users/ricard/data/NMT-seq_EB/rna/raw"
io$outfile <- "/Users/ricard/data/NMT-seq_EB/rna/parsed/raw_counts.txt"
...
write.table(counts,io$outfile,sep="\t",row.names=F,col.names=T,quote=F)
