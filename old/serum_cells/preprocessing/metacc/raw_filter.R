...
if (grepl("ricard",Sys.info()['nodename'])) {
  ...
  if (opts$context=="CG") {
    io$indir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/met/raw/allele_unspecific"
    io$outdir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/met/raw/allele_unspecific/filtered"
    # io$indir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/met/raw/allele_unspecific/2i"
    # io$outdir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/met/raw/allele_unspecific/filtered/2i"
  } else {
    # io$indir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/acc/raw/allele_unspecific"
    # io$outdir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/acc/raw/allele_unspecific/filtered"
    io$indir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/acc/raw/allele_unspecific/2i"
    io$outdir <- "/hps/nobackup/stegle/users/ricard/NMT-seq/acc/raw/allele_unspecific/filtered/2i"
  }
}
